...
CLI::App *AutoTuneCommand::CreateCommandCLI(CLI::App &app) {
    ...
    auto_tune
        ->add_option(
            ...
            R"foo(Rather than auto-tune each file individually, identify sets of files and tune them all in an identical manner based on a single authority file in that set. 
